...
def main():
    ...
    parser.add_argument("--hf_repo", default="USER18/screenplay-features",
                       help="Hugging Face repo for features (default: USER18/screenplay-features)")
    
    # Output
    parser.add_argument("--output", type=str,
                       default="./outputs/pca_ensemble_advanced.pkl",
