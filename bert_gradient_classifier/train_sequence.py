...
def load_features_from_huggingface(
    ...
    split: str,
    hf_repo: str = "USER18/screenplay-features",
...
class MovieDataset(Dataset):
    ...
    def __init__(
        ...
        hf_repo: str = "USER18/screenplay-features",  # Hugging Face repository name
        ...
        Args:
            ...
            hf_repo: Hugging Face repository name (default: "USER18/screenplay-features")
...
def main():
    ...
    parser.add_argument("--hf-repo", type=str, default="USER18/screenplay-features",
                        help="Hugging Face repository name (default: USER18/screenplay-features)")
    ...
    for exp_name in experiment_names:
        ...
        hf_repo = getattr(args, 'hf_repo', 'USER18/screenplay-features')
