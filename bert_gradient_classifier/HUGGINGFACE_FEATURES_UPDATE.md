...
Updated `train_sequence.py` to support loading features directly from Hugging Face datasets (`USER18/screenplay-features`) instead of requiring local parquet files.
...
- `--hf-repo`: Specify Hugging Face repository (default: "USER18/screenplay-features")
